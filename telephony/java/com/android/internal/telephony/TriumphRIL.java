 ...
 * status separately.
 * Custom Qualcomm No SimReady RIL for LGE, Renamed For Motorola 
 * Triumph Like Devices.
 *
 * {@hide}
 */

public class TriumphRIL extends RIL implements CommandsInterface {
    ...
    public TriumphRIL(Context context, int networkMode, int cdmaSubscription) {
